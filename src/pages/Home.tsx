    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative h-screen flex items-center justify-center text-white text-center px-6">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-100 mb-10 px-4">
            {t('heroSubtitle', 'Uncover a world of unique homes and unforgettable experiences')}
          </p>
          <Link 
            to="/contact"
            className="inline-block bg-white text-black px-8 sm:px-10 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-black hover:text-white transition shadow-lg"
          >
