    ...
    <div style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Un overlay sombre fixe pour la lisibilité sur l'image en tout temps */}
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link 
              to="/listings" 
              className="w-full sm:w-auto px-8 py-4 font-bold uppercase tracking-widest text-sm transition-colors hover:opacity-90 text-black"
            ...
            <Link 
              to="/contact" 
              className="w-full sm:w-auto px-8 py-4 bg-transparent border font-bold uppercase tracking-widest text-sm transition-colors text-white"
      ...
      <section className="py-24" style={{ backgroundColor: 'var(--bg)' }}>
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-10 -left-10 p-8 max-w-sm hidden md:block shadow-2xl" style={{ backgroundColor: 'var(--bg)', border: '1px solid var(--border)' }}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="p-8 border transition-all duration-300 group" style={{ backgroundColor: 'var(--bg)', borderColor: 'var(--border)' }}>
      ...
      <section className="py-32 text-center" style={{ backgroundColor: 'var(--accent)' }}>
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-wider mb-6 text-black">
            {t('cta_title_1', 'Votre investissement commence')} <span className="font-serif-italic lowercase text-white mix-blend-difference">{t('cta_title_em', 'aujourd\'hui.')}</span>
          </h2>
