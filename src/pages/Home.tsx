    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans pt-20">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center text-white px-6">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <Link 
            to="/listings"
            className="inline-block bg-white text-black px-10 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition"
          >
            Explore Listings
          </Link>
        </div>
              ...
              <div key={listing.id} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between text-sm text-gray-600 mb-6">
                    <div className="flex items-center gap-1"><Bed className="w-5 h-5" /> {listing.beds}</div>
                    <div className="flex items-center gap-1"><Bath className="w-5 h-5" /> {listing.baths}</div>
                    <div className="flex items-center gap-1"><Square className="w-5 h-5" /> {listing.area}</div>
                  </div>
      ...
      <footer className="bg-gray-900 text-white py-16 px-6 text-center">
        ...
        <p className="text-sm text-gray-400 mb-1">{companyInfo.location}</p>
        <p className="text-sm text-gray-400">WhatsApp: {companyInfo.whatsapp}</p>
        <p className="text-sm text-gray-500 mt-8">© 2025 {companyInfo.brand}. All rights reserved.</p>
      </footer>
    </div>
  );
}
