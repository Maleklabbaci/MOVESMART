  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative h-[100svh] md:h-screen overflow-hidden">
        {/* Background en CSS => toujours full screen (mobile/PC), zéro “moitié grise/noire” */}
        <div
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4 sm:px-6">
          <div className="w-full max-w-3xl pt-20 sm:pt-24">
            ...
            <p className="mt-5 text-sm sm:text-base md:text-xl text-white/90 max-w-2xl mx-auto">
            ...
            <div className="mt-8">
              <Link
                to="/contact"
                className="inline-block px-8 md:px-10 py-3 md:py-4 rounded-full font-bold text-base md:text-lg shadow-lg transition-colors duration-200
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
              <div className="bg-gray-50 p-6 rounded-2xl">
                ...
                <p className="text-xs text-gray-600">{t('remoteWorkDesc', 'Fast Wi‑Fi included')}</p>
              </div>

              <div className="bg-gray-50 p-6 rounded-2xl">
                <Users className="w-7 h-7 mb-3 text-gray-900" />
                <h4 className="font-bold text-base mb-1">{t('familyGetaways', 'Family Getaways')}</h4>
                <p className="text-xs text-gray-600">{t('familyGetawaysDesc', 'Family memories')}</p>
              </div>
            </div>

            <Link
              to="/listings"
              className="inline-block bg-black text-white px-8 py-3.5 rounded-full font-bold hover:bg-gray-800 transition"
            >
      ...
      <section className="bg-gray-50 py-16 md:py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight mb-10 text-center">
              ...
              >
                <div className="relative h-48 md:h-52">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="absolute top-3 left-3 bg-white/90 px-2 py-1 rounded-full text-xs font-bold">
                    {listing.type}
                  </span>
                </div>
                ...
                <div className="p-4 md:p-6">
                  ...
                  <Link
                    ...
                    className="block w-full text-center bg-black text-white py-2.5 rounded-full font-bold text-sm hover:bg-gray-800 transition"
                  >
      ...
      <section className="py-16 md:py-24 px-6 text-center">
        <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight mb-10">
      ...
      <section className="bg-black py-16 md:py-24 px-6 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
          <input
            ...
            className="px-6 py-3 rounded-full text-black text-sm w-full"
          />
