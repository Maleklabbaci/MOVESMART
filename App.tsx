...
function LangSelector() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute top-full mt-2 py-1 z-50"
          style={{ backgroundColor: 'var(--bg3)', border: '1px solid var(--border)', minWidth: 110, right: 0 }}>
          {LANGS.map(l => (
            <button key={l.code} onClick={() => change(l.code)}
              ...
              style={{ color: l.code === i18n.language ? 'var(--accent)' : 'var(--text3)', backgroundColor: l.code === i18n.language ? 'var(--accent-bg)' : 'transparent' }}
      ...
      <div className="h-full max-w-6xl mx-auto px-6 md:px-10 flex items-center justify-between">
        <Link to="/">
          <img src="https://i.ibb.co/60PJ8PVw/aass.png" alt={companyInfo.brand}
            className="h-7 md:h-9 w-auto" style={{ filter: 'var(--img-filter)' }}
